<?php
/**
 * Registrazione utente + geocoding
 * author: socialforger
 */
...
class Woosm_Registration {
    ...
    public function maybe_handle_registration_submit() {
        ...
        // Geocoding (per suggerire, non per assegnare gruppi)
        ...
        // Nessun gruppo viene assegnato qui: solo dopo ordine + pagamento.
